...
>
  <head>
    ...
    <title>@yield('title') | Hotel Bunga Permata</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Bunga Permata</span>
            </a>
          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->routeIs('staffs*') ? 'active' : '' }}">
                  <a href="{{ route('staffs.index') }}" class="menu-link">
                    <div data-i18n="Fluid">Staffs</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item {{ request()->routeIs('rooms*') ? 'active' : '' }}">
                <a href="{{ route('rooms.index') }}" class="menu-link">
                  ...
                  <div data-i18n="Tables">Rooms</div>
                </a>
              </li>

              <li class="menu-item {{ request()->routeIs('whats-new*') ? 'active' : '' }}">
                <a href="{{ route('whats-new.index') }}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-table"></i>
                  <div data-i18n="Tables">What's New</div>
                </a>
              </li>
              ...
              <li class="menu-item {{ request()->routeIs('explores*') ? 'active' : '' }}">
                <a href="{{ route('explores.index') }}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-table"></i>
                  <div data-i18n="Tables">Explore</div>
                </a>
              </li>
          </ul>
        </aside>
